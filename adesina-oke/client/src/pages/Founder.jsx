export default function Founder() {
  return (
    <div style={{ paddingTop: '68px' }}>
      <section style={{ background: '#FAF7F2', padding: '60px 5vw' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px,1fr))', gap: '40px', alignItems: 'start', maxWidth: '1000px' }}>
          {/* Card */}
          <div style={{ background: '#1A1208', borderRadius: '4px', padding: '36px 28px', textAlign: 'center' }}>
            <div style={{ width: '80px', height: '80px', borderRadius: '50%', background: '#B8963E', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Playfair Display',serif", fontSize: '1.6rem', color: '#1A1208', margin: '0 auto 1.25rem' }}>TAO</div>
            <div style={{ fontFamily: "'Playfair Display',serif", color: '#fff', fontSize: '1.1rem', fontWeight: 500, marginBottom: '4px' }}>Taslim Adesina Oke</div>
            <div style={{ fontSize: '0.75rem', color: '#D4AF6A', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Esq. – Principal Partner</div>
          ...
          {/* Bio */}
          <div>
            <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: 'clamp(1.6rem,4vw,2.4rem)', fontWeight: 500, color: '#1A1208', marginBottom: '1.5rem' }}>Adesina Oke, Esq.</h1>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
              {['⚖ Legal Director, CISLAC', '🌍 Transparency International – Nigeria', '🏛 World Bank Forum Participant', '📜 Anti-Corruption Advocate'].map(badge => (
                <span key={badge} style={{ display: 'inline-flex', alignItems: 'center', background: '#F5EDD6', border: '1px solid rgba(184,150,62,0.3)', borderRadius: '2px', padding: '6px 12px', fontSize: '0.78rem', color: '#3D3020' }}>
                  {badge}
                </span>
              ))}
            </div>

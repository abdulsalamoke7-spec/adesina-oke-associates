        ...
        <div style={{ maxWidth: '1100px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px,1fr))', gap: '48px', alignItems: 'start' }}>
            <div>
              ...
              <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(1.6rem,4vw,2.6rem)', fontWeight: 500, color: '#1A1208', marginBottom: '1.5rem' }}>
              ...
              <p style={{ color: '#6B5C42', marginBottom: '1.25rem', fontSize: '0.97rem' }}>
                We provide rigorous legal counsel informed by years of engagement with governance, civil society, and international advocacy frameworks.
              </p>
              <blockquote style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(1.1rem,3vw,1.4rem)', fontStyle: 'italic', color: '#3D3020', borderLeft: '2px solid #B8963E', paddingLeft: '1.5rem', margin: '2rem 0', lineHeight: 1.6 }}>
